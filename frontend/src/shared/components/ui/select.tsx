...
export function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        'flex h-10 w-full min-w-0 items-center justify-between gap-2 rounded-md bg-white px-3 text-sm font-medium text-stone-900 shadow-[0_0_0_1px_rgb(214_211_209)] outline-none transition',
        'placeholder:text-stone-400',
        'hover:bg-stone-50 active:bg-stone-100',
        'focus:shadow-[0_0_0_1px_rgb(28_25_23)] focus:ring-2 focus:ring-stone-900/15',
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-4 shrink-0 text-stone-500" />
...
export function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <ChevronUpIcon className="size-4 text-stone-500" />
    </SelectPrimitive.ScrollUpButton>
  )
}
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-stone-200 bg-white text-stone-900 shadow-lg',
...
export function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        'relative flex w-full cursor-default select-none items-center rounded-sm py-2 pl-8 pr-2 text-sm font-medium text-stone-900 outline-none',
        'focus:bg-stone-100 focus:text-stone-950 data-[highlighted]:bg-stone-100 data-[highlighted]:text-stone-950',
        'data-[state=checked]:bg-stone-100 data-[state=checked]:text-stone-950',
        'data-[disabled]:pointer-events-none data-[disabled]:text-stone-400',
        className,
      )}
      {...props}
    >
