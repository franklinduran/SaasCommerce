...
public sealed class InventoryMovementConfiguration : IEntityTypeConfiguration<InventoryMovement>
{
  public void Configure(EntityTypeBuilder<InventoryMovement> builder)
  {
    ...
    builder.Property(movement => movement.PurchaseId);

    builder.Property(movement => movement.ReturnId);
    ...
    builder.HasIndex(movement => new { movement.BusinessId, movement.BranchId, movement.PurchaseId });
    builder.HasIndex(movement => new { movement.BusinessId, movement.BranchId, movement.ReturnId });
    builder.HasIndex(movement => new { movement.BusinessId, movement.TransferId });
  }
}
