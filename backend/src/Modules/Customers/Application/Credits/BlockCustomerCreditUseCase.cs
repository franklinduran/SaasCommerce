...
public sealed class BlockCustomerCreditUseCase(
  ICustomerRepository customers,
  ICustomerCreditRepository credits,
  ICurrentUserService currentUser,
  IRealtimeNotifier realtime,
  IClock clock,
  IUnitOfWork unitOfWork) : IBlockCustomerCreditUseCase
{
    ...
    CancellationToken cancellationToken = default)
  {
    ...
    return ChangeStatusAsync(command.CustomerId, true, cancellationToken);
  }
    ...
    CancellationToken cancellationToken)
  {
    ...
    await realtime.NotifyBusinessAsync(
      businessId,
      CustomerCreditRealtimeEvents.CreditBlocked,
